...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Logo Veterinaria PetSoft 2018 Junio(1).png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(con.ValidarUsuario(txtRut.getText(), contraseña) == true){
            rut = txtRut.getText();
            this.setVisible(false);            
            Menú_Principal m = new Menú_Principal();
            m.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(null, "No existe el usuario", "Error", 0);
        }
